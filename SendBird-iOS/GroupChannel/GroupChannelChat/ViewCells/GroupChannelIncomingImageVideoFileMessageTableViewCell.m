//
//  GroupChannelIncomingImageVideoFileMessageTableViewCell.m
//  SendBird-iOS
//
...
@interface GroupChannelIncomingImageVideoFileMessageTableViewCell()

@property (strong) SBDFileMessage *msg;

@end

@implementation GroupChannelIncomingImageVideoFileMessageTableViewCell
